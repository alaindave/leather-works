...
export default function AddPayrollEmployeeProfileModal({ type, onCreated, employeeID, }) {
    ...
    async function save() {
        ...
        try {
            ...
            await window.electron.payrollEmployeeProfiles.create(employeeID, component);
            toast({
